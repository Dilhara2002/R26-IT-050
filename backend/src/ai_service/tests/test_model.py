...
class ModelTestCase(unittest.TestCase):
    ...
    def test_gemini_timeout_and_http_diagnostics_are_sanitized(self):
        ...
        expected_model = model._safe_gemini_model_for_log(
            os.environ.get("GEMINI_MODEL", "").strip() or model.DEFAULT_GEMINI_MODEL
        )
        ...
        self.assertIn(f"model={expected_model}", timeout_log)
        ...
        self.assertIn(f"model={expected_model}", http_log)
