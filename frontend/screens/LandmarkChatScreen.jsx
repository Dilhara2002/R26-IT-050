...
export default function LandmarkChatScreen({ landmarkContext, onBack, navigation }) {
  const activeLandmark = landmarkContext?.landmark_name || landmarkContext?.class_id?.replace(/_/g, " ") || "";
