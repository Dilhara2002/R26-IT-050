...
const styles = StyleSheet.create({
  ...
  eyebrow: { color: colors.turmeric, fontSize: 12, fontWeight: "900", letterSpacing: 1.1, marginBottom: 9 },
  title: { color: "#FFFFFF", fontSize: 30, lineHeight: 37, fontWeight: "700", fontFamily: "serif" },
  subtitle: { color: colors.backgroundDeep, fontSize: 15, lineHeight: 23, marginTop: 8 },
  ...
  cardEyebrow: { color: colors.cinnamon, fontSize: 11, fontWeight: "900", letterSpacing: 1, marginBottom: 7 },
  cardTitle: { color: colors.text, fontSize: 21, lineHeight: 27, fontWeight: "700", fontFamily: "serif" },
  ...
  metric: { flexGrow: 1, flexBasis: 150, minWidth: 0, backgroundColor: colors.background, borderRadius: 12, padding: 12, margin: 4 },
  metricLabel: { color: colors.cinnamon, fontSize: 12, fontWeight: "700" },
  ...
  actionHeading: { color: colors.text, fontSize: 18, fontWeight: "700", fontFamily: "serif" },
  ...
  alternativeButton: { backgroundColor: colors.primary, flexGrow: 1, flexBasis: 240 },
  mapButton: { backgroundColor: colors.primaryDark, flexGrow: 1, flexBasis: 240 },
  vehicleButton: { backgroundColor: colors.cinnamon, flexGrow: 1, flexBasis: 240 },
  ...
  sectionTitle: { color: colors.text, fontSize: 22, lineHeight: 28, fontWeight: "700", fontFamily: "serif" },
  sectionSubtitle: { color: colors.muted, lineHeight: 20, marginTop: 3 },
  stopCount: { color: colors.primary, backgroundColor: colors.backgroundDeep, borderRadius: 14, paddingHorizontal: 11, paddingVertical: 6, fontWeight: "900", marginTop: 6 },
  ...
  stopName: { color: colors.text, fontSize: 18, lineHeight: 23, fontWeight: "700", fontFamily: "serif", flexWrap: "wrap" },
  stopMeta: { color: colors.muted, fontSize: 13, marginTop: 3 },
  stopSummary: { color: colors.text, lineHeight: 20, marginTop: 12 },
  ...
  evidencePanel: { backgroundColor: colors.background, borderRadius: 12, padding: 12, marginTop: 4 },
  ...
  researchCard: { backgroundColor: colors.card, borderColor: colors.border, borderWidth: 1, borderRadius: 20, padding: 18, marginBottom: 14 },
  ...
  guideCard: { backgroundColor: colors.card, borderColor: colors.turmeric, borderWidth: 1, borderRadius: 20, padding: 18, marginBottom: 14 },
  guideNote: { color: colors.cinnamon, fontSize: 13, lineHeight: 20, marginTop: 7, marginBottom: 12 },
  guideSection: { marginTop: 10 },
  guideStop: { backgroundColor: "#FFFFFF", borderRadius: 13, padding: 13, marginTop: 10, borderWidth: 1, borderColor: colors.border },
  guideSectionTitle: { color: colors.primaryDark, fontSize: 16, lineHeight: 21, fontWeight: "900", flexWrap: "wrap" },
  guideBody: { color: colors.text, fontSize: 15, lineHeight: 23, marginTop: 5, flexWrap: "wrap" },
