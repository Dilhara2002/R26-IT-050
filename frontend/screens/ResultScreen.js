...
const styles = StyleSheet.create({
  ...
  content: { width: "100%", maxWidth: 820, alignSelf: "center", padding: 20, paddingBottom: 52 },
  ...
  eyebrow: { color: colors.turmeric, fontSize: 10, fontWeight: "900", letterSpacing: 1.3, marginBottom: 9 },
  title: { color: "#F1E9D2", fontSize: 31, lineHeight: 38, fontWeight: "600", fontFamily: "serif" },
  subtitle: { color: colors.backgroundDeep, fontSize: 14, lineHeight: 22, marginTop: 8 },
  ...
  cardEyebrow: { color: colors.cinnamon, fontSize: 10, fontWeight: "900", letterSpacing: 1, marginBottom: 7 },
  cardTitle: { color: colors.text, fontSize: 21, lineHeight: 27, fontWeight: "600", fontFamily: "serif" },
  ...
  metric: { flexGrow: 1, flexBasis: 150, minWidth: 0, backgroundColor: colors.backgroundDeep, borderRadius: 12, padding: 12, margin: 4 },
  ...
  limitNote: { color: colors.muted, fontSize: 13, lineHeight: 20, marginTop: 13 },
  ...
  neutralBanner: { backgroundColor: colors.backgroundDeep, borderColor: colors.border },
  statusTitle: { color: colors.text, fontWeight: "900" },
  statusText: { color: colors.muted, lineHeight: 19, marginTop: 2 },
  ...
  messageLoading: { backgroundColor: colors.backgroundDeep, borderColor: colors.border },
  messageError: { backgroundColor: "#FEF2F2", borderColor: "#FCA5A5" },
  messageText: { color: "#334155", lineHeight: 20, fontWeight: "700" },
  actionCard: { backgroundColor: colors.card, borderRadius: 18, padding: 16, marginBottom: 20, borderWidth: 1, borderColor: colors.border },
  actionHeading: { color: colors.text, fontSize: 18, fontWeight: "600", fontFamily: "serif" },
  actionHelper: { color: colors.muted, lineHeight: 20, marginTop: 3, marginBottom: 10 },
  ...
  alternativeButton: { backgroundColor: colors.cinnamon, flexGrow: 1, flexBasis: 220 },
  mapButton: { backgroundColor: colors.primaryDark, flexGrow: 1, flexBasis: 220 },
  vehicleButton: { backgroundColor: colors.primary, flexGrow: 1, flexBasis: 220 },
  ...
  sectionTitle: { color: colors.text, fontSize: 22, lineHeight: 28, fontWeight: "600", fontFamily: "serif" },
  sectionSubtitle: { color: colors.muted, lineHeight: 20, marginTop: 3 },
  stopCount: { color: colors.cinnamon, backgroundColor: colors.backgroundDeep, borderRadius: 14, paddingHorizontal: 11, paddingVertical: 6, fontWeight: "900", marginTop: 6 },
  stopList: { marginBottom: 18 },
  stopCard: { backgroundColor: colors.card, borderRadius: 18, padding: 16, marginBottom: 11, borderWidth: 1, borderColor: colors.border, elevation: 1 },
  stopHeader: { flexDirection: "row", alignItems: "center" },
  sequence: { width: 38, height: 38, borderRadius: 19, paddingTop: 8, textAlign: "center", backgroundColor: colors.primary, color: "#FFFFFF", fontWeight: "900", marginRight: 12 },
  stopHeadingCopy: { flex: 1, minWidth: 0 },
  stopName: { color: colors.text, fontSize: 18, lineHeight: 23, fontWeight: "900", flexWrap: "wrap" },
  stopMeta: { color: colors.muted, fontSize: 13, marginTop: 3 },
  ...
  replaceButton: { minHeight: 44, borderRadius: 11, paddingHorizontal: 12, paddingVertical: 11, margin: 5, backgroundColor: colors.backgroundDeep, borderWidth: 1, borderColor: colors.border, flexShrink: 1 },
  replaceButtonText: { color: colors.primary, fontWeight: "900", flexWrap: "wrap" },
  evidencePanel: { backgroundColor: colors.backgroundDeep, borderRadius: 12, padding: 12, marginTop: 4 },
  evidenceRow: { flexDirection: "row", flexWrap: "wrap", borderBottomWidth: 1, borderBottomColor: "#E2E8F0", paddingVertical: 7 },
  evidenceLabel: { color: colors.muted, fontWeight: "800", flexBasis: 190, flexGrow: 1 },
  evidenceValue: { color: colors.text, flexBasis: 260, flexGrow: 2, lineHeight: 19, minWidth: 0 },
  deterministicStopText: { color: colors.muted, fontSize: 13, lineHeight: 20, marginTop: 10 },
  sourceLink: { color: colors.primary, fontWeight: "900", textDecorationLine: "underline", lineHeight: 20, marginTop: 10, flexWrap: "wrap" },
  ...
  inlineButtonText: { color: colors.primary, fontWeight: "900", textDecorationLine: "underline" },
  stageList: { backgroundColor: "rgba(255,255,255,0.62)", borderRadius: 12, padding: 12 },
  stageText: { color: colors.muted, fontSize: 13, lineHeight: 20, marginBottom: 3, flexWrap: "wrap" },
  ...
  guideUnavailableTitle: { color: colors.muted, fontWeight: "900" },
  guideUnavailableText: { color: colors.muted, lineHeight: 20, marginTop: 3 },
  disabledButton: { opacity: 0.5 },
  pressed: { opacity: 0.76 },
  missingResult: { flex: 1, alignItems: "center", justifyContent: "center", padding: 24, backgroundColor: colors.background },
  missingTitle: { color: "#991B1B", fontWeight: "900", fontSize: 20 },
  missingText: { color: colors.muted, fontSize: 15, lineHeight: 22, textAlign: "center", marginTop: 7 },
});
