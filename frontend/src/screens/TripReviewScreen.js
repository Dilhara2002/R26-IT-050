...
export default function TripReviewScreen({ route, navigation }) {
  const { selectedVehicle = {}, tripResult = {} } = route.params || {};
  ...
  return (
    <ScrollView style={styles.page} contentContainerStyle={styles.content}>
      ...
      {confirmed ? (
        <View style={styles.confirmed}><Ionicons name="checkmark-circle" size={22} color="#15803D" /><Text style={styles.confirmedText}>Vehicle booking request is ready.</Text></View>
      ) : (
      ...
      <TouchableOpacity style={styles.itineraryButton} onPress={() => navigation.navigate("ItineraryHome")}><Ionicons name="map-outline" size={19} color={colors.primary} /><Text style={styles.itineraryText}>Add to Smart Itinerary</Text></TouchableOpacity>
