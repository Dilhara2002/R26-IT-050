...
export default function WelcomeScreen({ onLogin, onRegister, onAdminLogin }) {
  return <View style={s.page}>
    ...
    <View style={s.content}>
      ...
      <View style={s.actions}>
        ...
        <TouchableOpacity style={s.admin} onPress={onAdminLogin}><Ionicons name="shield-checkmark-outline" size={16} color="#C9B98F"/><Text style={s.adminText}>Administrator sign in</Text></TouchableOpacity>
...
const s = StyleSheet.create({
  ...
  actions:{gap:12},primary:{height:58,borderRadius:16,backgroundColor:"#D89A1F",flexDirection:"row",alignItems:"center",justifyContent:"center",gap:10},primaryText:{color:"#1C2A44",fontWeight:"800",fontSize:16},secondary:{height:56,borderRadius:16,borderWidth:1,borderColor:"rgba(241,233,210,.35)",alignItems:"center",justifyContent:"center"},secondaryText:{color:"#F1E9D2",fontWeight:"700",fontSize:15},admin:{flexDirection:"row",alignItems:"center",justifyContent:"center",gap:7,paddingVertical:7},adminText:{color:"#C9B98F",fontWeight:"700",fontSize:12},terms:{color:"#C9B98F",textAlign:"center",fontSize:10,marginTop:5}
});
